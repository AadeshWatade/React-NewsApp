...
const Navbar = (props) => {
        ...
        return (
            <div>
                <nav className="navbar fixed-top navbar-expand-lg navbar-dark bg-dark" style={{backgroundColor:props.mode==='light'?'#212529':'black', color:props.mode==='light'?'black':'white'}}>
